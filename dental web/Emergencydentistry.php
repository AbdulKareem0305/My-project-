...
<head>
    ...
    <link rel="stylesheet" href="./css/Emergencydentistry.css">
...
<section class="service">
    <div class="service-image">
      <img src="./image/dentist-appointment-dental-clinic-placing-braces-locks-teeth-pulling-archwire-fix-it_597987-5687.avif" alt="Service Image">
    </div>
    <div class="service-details">
      <h2>Emergency Dentistry</h2>
      <p>If you're experiencing a dental emergency, it's important to seek treatment as soon as possible. Delaying treatment can lead to more serious issues and even permanent damage to your teeth and gums. Our clinic is equipped to handle a range of dental emergencies, and we offer flexible scheduling and extended hours to ensure that you can get the care you need when you need it.</p>
      <a href="./booknow.php" class="btn" id=""> Book Now <span class="fas fa-chevron-right"></span> </a>
    </div>
  </section>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="./booknow.php"> <i class="fas fa-chevron-right"></i> book </a>
